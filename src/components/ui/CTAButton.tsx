...
const ctaVariants = cva(
  "inline-flex items-center justify-center rounded-full font-tajawal-semibold text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary: "bg-gradient-to-r from-gradient-start via-primary to-gradient-end shadow-button text-primary-foreground hover:scale-[1.02] hover:shadow-lg active:scale-[0.98]",
